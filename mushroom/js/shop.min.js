! function(t, e, a, n) {
	...
	t.extend(i.prototype, {
		...
		add_cart_buttons: function() {
			var t = this;
			t.cart.parent().append('<button class="' + t.settings.cart + '-clear">清空购物车</button>'), t.cart.parent().append('<button class="' + t.settings.cart + '-checkout">结算</button>'), t.clear_cart()
		},
		checkout: function() {
			var e, a = this,
				n = {
